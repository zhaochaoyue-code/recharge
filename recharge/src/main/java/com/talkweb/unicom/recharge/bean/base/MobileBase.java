 ...
 */
public class MobileBase extends IDEntity {
	...
	*/
	...
	/**
	 * 处理状态。0待充值，1发送充值中，2已发送充值待查询状态，3发送状态查询中，4已状态查询充值成功待发送短信。5充值getFuture异常，6查询状态getFuture异常，7提交充值异常，8提交查询状态异常，9短信发送处理中，10短信发送成功，11发送短信异常，12充值失败(调接口返回)，13充值超时(调接口返回)
	*/
